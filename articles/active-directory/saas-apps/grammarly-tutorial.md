...
1. Grammarly application expects the SAML assertions in a specific format, which requires you to add custom attribute mappings to your SAML token attributes configuration. These attributes are also pre-populated but you can review them as per your requirements.
	
	| Name |  Source Attribute|
	| -------------- | --------- |
	| FirstName | user.givenname |
	| LastName | user.surname |
	| EmailAddress | user.principalname OR user.mail|
...
To configure single sign-on on **Grammarly** side, you need to copy the downloaded **Certificate (Base64)** and appropriate copied URLs from Azure portal to the Grammarly admin panel - [instructions](https://support.grammarly.com/hc/en-us/articles/360048683092-How-do-I-set-up-SAML-single-sign-on-for-my-Grammarly-Business-account-).
...
2. You can use Microsoft Access Panel. When you click the Grammarly tile in the Access Panel, you should be automatically signed in to the Grammarly for which you set up the SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
